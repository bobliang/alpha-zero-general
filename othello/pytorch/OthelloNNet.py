...
class OthelloNNet(nn.Module):
    ...
    def forward(self, s):
        ...
        # residual = s              # batch_size x 1 x board_x x board_y
        # x = self.bn1(self.conv1(s))                                  # batch_size x num_channels x board_x x board_y
        # x += residual
        # x = F.relu(x)
        # x = self.bn2(self.conv2(x))                                 # batch_size x num_channels x board_x x board_y
        # x += residual
        # x = F.relu(x)
